...
public class MainActivity extends AppCompatActivity {
    ...
    Button BtnHit,BtnKali,BtnKurang,BtnBagi,BtnSQR;
    TextView Hasil;
    String Dec1, Dec2;
    Integer Total;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BtnSQR.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Dec2 = Dectambah2.getText().toString();
                if (!TextUtils.isEmpty(Dec1) || !TextUtils.isEmpty(Dec2)) {
                    double inputNumber = !TextUtils.isEmpty(Dec1) ? Double.parseDouble(Dec1) : Double.parseDouble(Dec2);
                    double squareRoot = Math.sqrt(inputNumber);
                    Hasil.setText(String.valueOf(squareRoot));
                } else {
                    Hasil.setText("Mohon masukan angka");
                }
            }
